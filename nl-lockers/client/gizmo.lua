...
-- DataView is loaded from client/dataview.lua (loaded before this file in fxmanifest)
    ...
    CreateThread(function()
        while gizmoEnabled do
            ...
            lib.showTextUI(
                ...
                '[G]     - ' .. locale("disable_cursor") .. '/' .. locale("enable_cursor") .. '  \n' ..
...
-- Make it accessible from other client files in this resource
_G.UseGizmo = useGizmo
...
lib.addKeybind({
    ...
    onPressed = function(self)
        if not gizmoEnabled or _G.zoneSelectingActive then return end
